...
[![npm version](https://img.shields.io/npm/v/mcp-scout.svg)](https://www.npmjs.com/package/mcp-scout)
[![license](https://img.shields.io/npm/l/mcp-scout.svg)](LICENSE)
...
```json
{
  "mcpServers": {
    "scout": {
      "command": "npx",
      "args": ["-y", "mcp-scout", "/path/to/your/mcp-servers.json"]
    }
  }
}
```
